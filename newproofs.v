...
Lemma ten: forall(N0 W R: warvars) (N N': nvmem) (V V': vmem)
  ...
  + destruct_ms H0 T WT. remember T as T1. clear HeqT1.
...
+ destruct_ms H2 T WT; subst.
    ...
    - assert(exists(Csmall: context) (Osmall: obseq) (Wsmall: the_write_stuff),
        ...
        + eapply trace_steps. apply T. intros contra. inversion contra.
        subst. apply H2. reflexivity. destruct H3 as [Csmall rest].
   ...
   assert (Dis: bigif = c' \/
     ...
     by (apply classic). destruct Dis.
      ...
      - assert(exists(Csmall: context) (Osmall: obseq) (Wsmall: the_write_stuff),
        ...
        + eapply trace_steps. apply T. intros contra. inversion contra.
        subst. apply H3. reflexivity. destruct H4 as [Csmall rest].
